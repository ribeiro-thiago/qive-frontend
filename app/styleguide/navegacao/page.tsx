    ...
    <div className="p-6">
      <div className="container max-w-6xl">
        <header className="mb-8">
          <h1 className="text-2xl font-semibold text-[#0d0f1c]">Navegação</h1>
          <p className="text-sm text-[#71717c] mt-1">
            Documentação do componente Navegação do Qive Conecta.
          </p>
        </header>

        <Card>
          <CardHeader>
            <CardTitle>Componente Navegação</CardTitle>
          </CardHeader>
          <CardContent>
